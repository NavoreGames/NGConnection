	...
	public abstract class DataBase : Connection
	{
		...
		public override bool OpenConnection(bool openTansaction = false)
		{
			if (connection.State == ConnectionState.Open)
				return NGNotifier.AddWarning<bool>(true, "Connection is already open", "You are try open connection more than once or some process is not closing the connection");
